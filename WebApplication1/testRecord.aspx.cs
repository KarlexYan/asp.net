...
{
    public partial class testRecord : System.Web.UI.Page
    {
        ...
        {
            string sqlstr = "select a.QID,a.content,a.qoptions,a.score,c.myAnswer,c.myScore,c.testtime from tb_questions a,tb_paper b,tb_testRecord c " +
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string sqlstr = "update tb_testRecord set testTime=now(),myAnswer = '"+answer+"'"
                            + " where stuID= "+ stuID + " and QID= " + qid;
            //DialogResult dr = MessageBox.Show(sqlstr);
            MySqlConnection con = new MySqlConnection();
            con.ConnectionString = ConfigurationManager.AppSettings["RemoteConnectionString"];
            MySqlCommand cmd = new MySqlCommand();
